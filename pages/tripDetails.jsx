...
function TripDetails() {
    return (
        <div>
                        ...
                        <div className="col-md-6">
                            <div className={styles.happy_travling}>
                                ...
                                <div className={styles.main_back_btn11}>
                                    <Link href="/planTrip"><button className={styles.back_home_btn}><Image src={left_arrow} /><span className={styles.back_btn11}>Back To Home</span></button></Link>
                                </div>
                            </div>
                        </div>
            ...
            {/* <div>
                <Image src={trip_details_img} height={610} width={1377} />
                <div className={styles.happy_travel_main_div}>
