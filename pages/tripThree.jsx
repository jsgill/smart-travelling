            ...
            <form onSubmit={handleSubmit(onSubmit)} className="simpleForm">
              <div className="row justify-content-center">
                <div className="col-md-7 text-center">
                  ...
                  <input type="tel" autoComplete="off" maxLength={10} value={mobile} name="mobileNumber" className={styles.trip_three_inputs} onChange={(e) => setMobile(e.target.value)} onFocus={(e) => e.target.value = ""} onBlur={(e) => e.target.value = mobile} />
